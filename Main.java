...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ListElement head = new ListElement(null, 0);
        ...
        System.out.println("p: Print the list (head->tail)");
      ...
      public static void addNode(ListElement h, int toAdd){
          if(h.next == null)
          {
              h.next = new ListElement(null, toAdd);
          }
          else 
      ...
      public static void printList(ListElement h)
      {
          while(h.next != null)
          {
